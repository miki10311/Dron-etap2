...
/*!
 *  \file
 *  \brief Definicja klasy Przeszkoda_Plaszczyzna
 *
 *  Plik zawiera definicje klasy Przeszkoda_Plaszczyzna, ktora
 *  opisuje budowe przeszkody-plaszczyzny.
 *
 */
...
/*!
 *  \brief Klasa 'Przeszkoda_Plaszczyzna' opisuje budowe 
 *  przeszkody-plaszczyzny.
 *
 *  Publiczne:
 *     Konstruktor Przeszkoda_Plaszczyzna opisuje nam płaszczyzne-przeszkode.
...
/*!
 * \brief Opisuje nam budowe plaszczyzny.
 *
 * Argumenty:
 *    \param[in] dlugosc     - dlugosc plaszczyzny
 *    \param[in] szerokosc   - szerokosc plaszczyzny
 *    \param[in] wysokosc    - wysokosc plaszczyzny
 *    \param[in] nazwa_kopii - nazwa pliku tekstowego z kopia robocza
 *    \param[in] nazwa_oryg  - nazwa pliku tekstowego z oryginalem
 *    \param[in] punkty      - wektor 3D opisujacy wierzcholki plaszczyzny
 ...
 */
Przeszkoda_Plaszczyzna(double dlugosc, double szerokosc, double wysokosc, string nazwa_oryg, string nazwa_kopii) : Przeszkoda(dlugosc, szerokosc, wysokosc, nazwa_oryg, nazwa_kopii)
{
    Wektor3D punkt;
    ilosc_wierz=10;
    srodek=0;
...
virtual bool kolizja(Dron dron)
{
    ...
    {
        cout<<"Kolizja z przeszkoda: Plaszczyzna!"<<endl;
        return true;
    }
    return false;
}
